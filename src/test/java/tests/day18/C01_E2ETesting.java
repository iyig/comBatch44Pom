...
hotelMyCampPage.bekle(2);
        ...
        String basariliYazisiStr = hotelMyCampPage.basariliYazisiElementi.getText();
        Assert.assertTrue(hotelMyCampPage.basariliYazisiElementi.isDisplayed());

        //10. OK butonuna tıklayın.
    hotelMyCampPage.okButtonuElementi.click();
    }
}